...
import { Mail, Lock, UserPlus, Eye, EyeOff, User, LogIn as LoginIcon } from 'lucide-react';
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        >
                            <LoginIcon className="w-5 h-5 text-red-300 group-hover:text-red-200 transition-colors duration-200" />
